...
class CheckPwdViewModel : ViewModel() {
    ...
    val checkState: LiveData<Boolean>
        get() = _checkState
    ...
    fun checkLockNumber() {
        ...
        val pwdOriginal = Application.lockNumber.getAddNumber()
        _checkState.value = pwdOriginal.equals(pwd)
    }
